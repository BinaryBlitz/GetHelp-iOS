...
public class _FloatLabelCell<T where T: Equatable, T: InputTypeInitiable>: Cell<T>, UITextFieldDelegate, TextFieldCell {
    ...
    private func layoutConstraints() -> [NSLayoutConstraint] {
        ...
        return NSLayoutConstraint.constraintsWithVisualFormat("H:|-[floatLabeledTextField]-|", options: NSLayoutFormatOptions.AlignAllLastBaseline, metrics: metrics, views: views) + NSLayoutConstraint.constraintsWithVisualFormat("V:|-(vMargin)-[floatLabeledTextField]-(vMargin)-|", options: NSLayoutFormatOptions.AlignAllLastBaseline, metrics: metrics, views: views)
    }
